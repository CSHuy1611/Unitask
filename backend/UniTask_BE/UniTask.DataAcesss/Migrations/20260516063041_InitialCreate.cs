        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EkycStatus = table.Column<int>(type: "int", nullable: false),
                    EkycDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EkycFrontImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EkycBackImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVUploadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Commission = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    ...
                    SelectedStudentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedJobs_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Jobs_RelatedJobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_JobId_StudentProfileId",
                table: "Applications",
                columns: new[] { "JobId", "StudentProfileId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedJobs_StudentProfileId_JobId",
                table: "SavedJobs",
                columns: new[] { "StudentProfileId", "JobId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RelatedJobId",
                table: "Transactions",
                column: "RelatedJobId");
